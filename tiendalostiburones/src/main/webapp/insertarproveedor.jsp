	...
	<div style="padding-left: 5px">
		...
		<div class="container">
			...
			<div id="error" class="alert alert-danger visually-hidden"
					role="alert">Error al crear el proveedor, verifique que no exista el NIT y usuario dados</div>
			...
			<form id="form1">
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon1">NIT</span> <input
						...
						placeholder="Digite aquí el NIT sin digito de verificación..."
				...
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon2">Ciudad</span> <input
						type="text" class="form-control"
						placeholder="Digite aquí la ciudad de origen..."
				...
				<div class="input-group mb-3">
					...
					<input type="text" class="form-control"
						placeholder="Digite aquí la dirección..."
				...
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon4">Nombre proveedor</span> <input
						type="text" class="form-control"
						placeholder="Digite aqui el nombre..."
				...
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon5">Teléfono</span> <input
						type="text" class="form-control"
						placeholder="Digite aqui el teléfono..."
